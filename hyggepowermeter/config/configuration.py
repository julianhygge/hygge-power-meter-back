...
if APP_ENV == 'local':
    CONFIGURATION = PowerMeterSubscriberConfiguration(str(Path.cwd()) + "/config/{}.ini".format(APP_ENV))
else:
    CONFIGURATION = PowerMeterSubscriberConfiguration(str(Path.cwd()) + "/hyggepowermeter/config/{}.ini".format(APP_ENV))